...
| Category | Count |
|---|---|
| `retail` | 512 (includes online hotels/spas) |
| `restaurant` | 367 |
| `hotel` | 79 (physical hotels) |
| `spa` | 158 (physical spas) |
| `leisure` | 112 (experiences/attractions) |
...
- Geocoding 500 physical stores: add `GOOGLE_MAPS_API_KEY=<key>` to `.env`, then `python -m db.run_geocoding` (426/1226 geocoded)
